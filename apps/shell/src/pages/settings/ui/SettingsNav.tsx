 ...
 *
 * 结构按「分区列表」设计（data-section 锚；列表首项 = 模型设置）。W4 曾追加
 * 「工作空间」分区，后撤项并入「通用配置」（单配置独占一页浪费）。
 *
...
export type SettingsSectionId = "models" | "general" | "mcp" | "skills";
...
export const SETTINGS_SECTIONS: readonly {
  ...
  { id: "mcp", labelKey: "chat.settings.nav.mcp" },
  { id: "skills", labelKey: "chat.settings.nav.skills" },
];
