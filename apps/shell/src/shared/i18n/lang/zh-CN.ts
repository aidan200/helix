...
export const zhCN: Translations = {
  chat: {
    ...
    modelsConfig: {
      subtitle: "API key 集中管理 · 目录来自 builtin 静态表与 pi.dev 远程 overlay 合并",
      defaultLabel: "全局默认模型",
      defaultHint: "写入 SQLite · 新会话与草稿自动继承",
      refresh: "刷新目录",
      refreshedJustNow: "目录更新于 刚刚 · {n} providers · 缓存 4h",
      refreshedAt: "目录更新于 {time} · {n} providers · 缓存 4h",
      authPathHint: "key 写入 ~/.helix/auth.json（0600 权限 · 文件锁） · 刷新绕过缓存强制拉取 pi.dev",
      ...
      colCacheRead: "缓存读",
      colCacheWrite: "缓存写",
      tableCaption: "价格单位 $ / 1M tokens · 数据来自 ModelCatalog（成本字段供 usage 统计链）",
      defaultChip: "default",
      ...
      modalHint: "daemon 写入 ~/.helix/auth.json（0600 权限 · 跨进程文件锁） · 格式与 pi 生态 Credential 约定一致",
      cancel: "取消",
      save: "保存",
      keySavedToast: "{provider} key 已保存 · {masked}",
      keyDeletedToast: "{provider} key 已删除",
      refreshedToast: "目录已刷新 · 绕过缓存强制拉取",
      defaultUpdatedToast: "默认模型已更新为 {model} · 新会话与草稿继承",
    },
    tsFormat: "HH:mm",
  },
};
