...
export const zhCN = {
  ...
  pj: {
    ...
    kg: {
      ...
      reportTitle: "知识变化报告",
      reportCount: "{n} 条",
      reportClear: "本迭代 {n} 条已全部处理，图谱无待决事项。",
      decide: "需要你决定：",
      doneNote: "已处理：{value}",
      undo: "撤销",
      idxTitle: "索引状态",
      idxBuilding: "构建中 · {pct}%",
      idxBuildingWait: "构建中…",
      idxBuildingSub: "{done} / {total} 符号 · codegraph 机械抽取中（仅代码层）",
      idxBuildingSubWait: "codegraph 机械抽取中（仅代码层）…",
      idxSynced: "已同步",
    ...
    produce: {
      ...
      emptySub: "该项目的知识创建任务产出会按 任务 / 阶段 / 批次 分组呈现在这里：产出以代码事实落盘即 confirmed（正式知识），发现错误可在此修改或 supersede。",
