...
export const enUS = {
  ...
  pj: {
    ...
    kg: {
      ...
      reportPending: "{n} pending",
      reportCleared: "All clear",
      promote: "Confirm",
      ...
      reportClear: "All {n} entries of this iteration are resolved; no pending graph items.",
      decide: "Your call:",
      doneNote: "Resolved: {value}",
      undo: "undo",
      idxTitle: "Index status",
      idxBuilding: "Building · {pct}%",
      idxBuildingWait: "Building…",
      idxBuildingSub: "{done} / {total} symbols · codegraph mechanical extraction (code layer only)",
      idxBuildingSubWait: "codegraph mechanical extraction (code layer only)…",
      idxSynced: "Synced",
      idxSyncedSub: "{symbols} symbols · finished at {at}",
      idxInterrupted: "Build interrupted",
    ...
    produce: {
      ...
      emptySub: "Output of this project's knowledge creation tasks will appear here grouped by task / stage / batch: nodes land as confirmed knowledge from code facts; fix errors here via edit or supersede.",
