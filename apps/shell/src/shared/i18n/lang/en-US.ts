...
export const enUS: Translations = {
  chat: {
    ...
    modelSwitch: {
      ...
      configEntry: "Configure providers and default model",
      defaultBadge: "default",
      switchedToast: "Requested switch to {model} · effective next turn",
      resetToast: "Requested reset to default model {model}",
    },
    modelsConfig: {
      subtitle: "API keys managed centrally · catalog merges the builtin table with the pi.dev overlay",
      defaultLabel: "Global default model",
      defaultHint: "Written to SQLite · new sessions and drafts inherit it",
      refresh: "Refresh catalog",
      refreshedJustNow: "Catalog updated just now · {n} providers · 4h cache",
      refreshedAt: "Catalog updated {time} ago · {n} providers · 4h cache",
      authPathHint: "Keys are written to ~/.helix/auth.json (0600 · file lock) · refresh bypasses cache and pulls pi.dev",
      ...
      tableCaption: "Prices in $ / 1M tokens · from ModelCatalog (cost feeds the usage pipeline)",
      defaultChip: "default",
      ...
      modalHint: "daemon writes ~/.helix/auth.json (0600 · cross-process file lock) · format follows the pi ecosystem Credential convention",
      cancel: "Cancel",
      save: "Save",
      keySavedToast: "{provider} key saved · {masked}",
      keyDeletedToast: "{provider} key deleted",
      refreshedToast: "Catalog refreshed · cache bypassed",
      defaultUpdatedToast: "Default model set to {model} · inherited by new sessions and drafts",
    },
    tsFormat: "HH:mm",
  },
};
