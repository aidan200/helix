...
export const enUS = {
  chat: {
    ...
    settings: {
      ...
      skills: {
        title: "User skills",
        subtitle: "Skill directory ~/.helix/skills: drop <name>/SKILL.md (frontmatter with name and description) and it loads automatically; enable/disable per agent on the Agents page",
        loading: "Loading…",
        empty: "No user skills yet — create ~/.helix/skills/<name>/SKILL.md (frontmatter with name and description) and it loads automatically",
        kindMain: "Main",
        kindSub: "Subagent",
        enabled: "Enabled",
        disabled: "Disabled",
        ...
        fieldDescription: "One-line description (shown in agent skill list)",
        fieldBody: "Body (Markdown)",
        fieldBodyFull: "SKILL.md full text (with frontmatter, editable)",
        bodyPlaceholder: "Skill body: when to use, how, hard rules…",
        bodyFullPlaceholder: "---\nname: my-skill\ndescription: one-liner\n---\n\nSkill body…",
        importLabel: "Pick a SKILL.md file (raw import, editable below)",
        ...
        createFail: {
          ...
          "already-exists": "A skill with this name already exists under ~/.helix/skills",
          "bad-frontmatter": "SKILL.md must start with a --- frontmatter block (name and description)",
        },
      },
      mcp: {
        title: "MCP Server",
        subtitle: "Standard MCP access: declare a server → discover tools dynamically → wired into the agent tool surface (persists across restarts)",
        importLabel: "Import config",
    importFail: "Import failed: not a valid MCP config (expect mcpServers block or single server object with command)",
    importMulti: "Found {count} servers — filled in the first one (re-import for the rest)",
    addServer: "Add Server",
        fieldName: "Name (tool namespace prefix)",
        fieldCommand: "Command",
        fieldArgs: "Arguments (space-separated)",
        fieldEnabled: "Enabled (off = keep config, no connection)",
        fieldDeferred: "Lazy loading (tools loaded on demand via discover)",
        fieldDeferredHint: "When on, this server's tools are excluded from the initial tool set and loaded on demand when the agent calls `${server}__discover` (saves tokens); when off, all tools stay loaded per session",
        deferredBadge: "Lazy",
        addConfirm: "Add",
        adding: "Adding…",
        test: "Test Connection",
        testing: "Testing…",
        testOk: "Connected, {count} tools discovered",
        testFail: "Connection failed",
        formInvalid: "Name and command are required",
        connectFailed: "Connection failed (config kept, retry available)",
        addFailed: "Add failed",
        loading: "Loading…",
        empty: "No MCP servers yet — add one to get started (e.g. shadcn / magicui official MCP)",
        delete: "Delete",
      ...
      general: {
        ...
        groupScheduling: "SubAgent scheduling",
        groupPort: "Service port",
        maxConcurrent: "Max concurrent (maxConcurrent)",
        maxQueued: "Max queued (maxQueued)",
        wsPort: "WS listen port",
        schedNote: "Takes effect on next scheduling decision — no restart needed",
        portNote: "Applies on next start; current run port unchanged",
        portArgvOverride: "Current run overridden by --port to {port}; stored value does not affect this run",
        groupSandbox: "Command sandbox",
        sandbox: "Sandbox switch",
        sandboxOn: "On",
        sandboxOff: "Off",
        sandboxNote: "Applies to new sessions and new SubAgent tasks; running sessions keep their state. When on, bash and file writes are confined to the workspace and ~/.helix; auto-degrades to off if the self-check fails",
    ...
    modelsConfig: {
      ...
      thinkingDefaultLabel: "Global default thinking",
      thinkingDefaultClear: "Clear (unset = thinking off by default)",
      thinkingUnsupported: "The global fallback model has no thinking levels",
      ...
      sendFailToast: "Not connected to daemon; action not sent",
      writeFailToast: "Operation failed · {message}",
    },
    tsFormat: "HH:mm",
  },
  trace: {
  ...
  agents: {
    ...
    skillAudienceTask: "Task SOP",
    skillAudienceTaskHint: "Task-type SOP: injected in full via task kickoff; permanently disabled on agent faces (read-only)",
  ...
  pj: {
    ...
    health: {
      ...
      statIssues: "Structural issues",
      ledgerTitle: "candidates ledger",
      candPending: "pending",
