...
/** scrollTab 结果（页面内滚动脚本的返回值，如 "scrolled down 3000px"）。 */
...
/** screenshotTab 结果（截图落盘路径——LLM 后续用 read 工具读图）。 */
...
export interface BrowserPort {
  ...
  /** 截图：必须给 file 落盘（截图供 read 工具读图，base64 不进 content）；缺 file 抛错。 */
