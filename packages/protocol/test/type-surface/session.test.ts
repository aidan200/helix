...
const badChannel: SessionListChangedEvent = { v: "0.12", sessionId: "s", channel: "chat", type: "session.list_changed", payload: { kind: "created" } };

// 负向断言（v0.2）：session.loadHistory 缺游标
// @ts-expect-error beforeEntryId 必填
const badLoadHistory: SessionLoadHistoryCommand = { v: "0.12", sessionId: "s", type: "session.loadHistory", payload: {} };
